...
export function WhitepaperCard({ paper, delay = 0 }: WhitepaperCardProps) {
  ...
  return (
    <motion.div
      ...
      className="glass-card rounded-xl overflow-hidden group hover:shadow-lg
                 hover:shadow-neon/5 transition-all duration-500 flex flex-col"
    >
      {/* Thumbnail */}
      <div className="relative h-64 overflow-hidden flex items-center justify-center bg-surface-lowest">
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 60%, ${paper.tagColor}18 0%, transparent 70%)`,
          }}
        />
        <Icon size={80} className="relative z-10" style={{ color: `${paper.tagColor}45` }} />
        <div className="absolute inset-0 bg-gradient-to-t from-surface-lowest to-transparent opacity-60" />
        {/* Tag badge */}
        <div className="absolute top-4 left-4 z-20">
          <span
            className="bg-surface-highest/80 backdrop-blur px-3 py-1 rounded text-[10px]
      ...
      <div className="p-8 flex flex-col flex-1">
        <h3
          className="text-xl font-headline font-bold text-white mb-4 group-hover:text-neon
