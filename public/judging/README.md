# Judging Section Images
Place one image per event. Drop files here and update `imagePath` in `data/portfolio.ts` → `judgingEvents` array.

| Filename               | Event                  |
|------------------------|------------------------|
| hackindia.webp         | HackIndia National     |
